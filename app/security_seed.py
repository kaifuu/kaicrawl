...
MENU_DEFS = [
    ...
    ("任务-编辑", "task:edit", "button", "tasks.edit", "", "task:edit", "task", 2),
    ("任务-启停", "task:toggle", "button", "tasks.toggle", "", "task:toggle", "task", 3),
    ("任务-运行", "task:run", "button", "tasks.run", "", "task:run", "task", 4),
    ("任务-删除", "task:delete", "button", "tasks.delete", "", "task:delete", "task", 5),
